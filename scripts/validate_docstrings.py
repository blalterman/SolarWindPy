...
class SolarWindPyDocstringValidator:
    ...
    PHYSICS_UNITS = {
        r'\bm/s\b', r'\bkm/s\b', r'\bm\^2/s\b', r'\bkg\b', r'\bK\b',
        r'\bnT\b', r'\bmT\b', r'\bT\b', r'\bcm\^-3\b', r'\b1/cc\b',
        r'\beV\b', r'\bkeV\b', r'\bJ\b', r'\bPa\b', r'\bN/m\^2\b',
        r'\brad\b', r'\bdeg\b', r'\bs\b', r'\bmin\b', r'\bh\b',
        r'\bAU\b', r'\bkm\b', r'\bm\b', r'\bcm\b', r'\bmm\b'
    }
    ...
    def validate_docstring_structure(self, docstring: str, component_type: str, 
                                   name: str, line: int) -> List[Dict]:
        ...
        issues.extend(self._validate_scientific_requirements(
    ...
    def _validate_scientific_requirements(self, docstring: str, component_type: str,
                                        name: str, line: int) -> List[Dict]:
    ...
    def _likely_physics_function(self, name: str, docstring: str) -> bool:
        ...
        physics_keywords = [
            'temperature', 'velocity', 'magnetic', 'plasma', 'thermal',
            'energy', 'pressure', 'density', 'speed', 'mass', 'charge'
        ]
    ...
    def _likely_mathematical_function(self, name: str, docstring: str) -> bool:
        ...
        math_keywords = [
            'calculate', 'compute', 'sqrt', 'log', 'exp', 'integrate',
            'derivative', 'equation', 'formula', 'algorithm'
        ]
        text = (name + ' ' + docstring).lower()
    ...
    def _needs_examples(self, name: str, docstring: str, component_type: str) -> bool:
        ...
        if param_section:
            param_count = len(re.findall(r'^\s*\w+\s*:', param_section.group(1), re.MULTILINE))
            if param_count > 3:
                return True
...
def generate_validation_report(solarwindpy_path: Path, 
                             output_format: str = 'detailed') -> None:
    ...
    print(f"Files with Issues: {len(set(issue.get('name', '').split('.')[0] for issue in all_issues))}")
    print()
...
def main():
    ...
    parser.add_argument('--path', type=str, default='solarwindpy',
