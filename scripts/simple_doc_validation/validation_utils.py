...
"""
    ...
    if summary.get('total_tests', 0) > 0:
        success_rate = ((summary['total_tests'] - summary['failed_tests']) / summary['total_tests']) * 100
...
def main():
    ...
    parser.add_argument('--count-examples', action='store_true', help='Count documentation examples')
