...
class DoctestPhysicsValidator:
    ...
    def validate_thermal_speed(self, thermal_speed: float, 
                             temperature: float, 
    ...
    def validate_units(self, value: float, unit_type: str, 
                      expected_range: tuple = None) -> bool:
...
def validate_doctest_output(output: Any, 
