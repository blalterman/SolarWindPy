...
Auto-validates physics constraints after code edits.
"""
...
def validate_physics(filepath):
    ...
    if 'temperature' in content.lower() or 'density' in content.lower():
        ...
        if re.search(r'[Tt]emperature.*-', content) or re.search(r'[Dd]ensity.*-', content):
...
def main():
    ...
    relevant_dirs = ['solarwindpy/core', 'solarwindpy/instabilities', 
                    'solarwindpy/fitfunctions', 'solarwindpy/tools']
