...
class TestExtremaCalculator:
    ...
    def simple_test_data(self):
        ...
        values = [10, 20, 30, 50, 80, 100, 120, 100, 80, 50, 30, 20, 
                 15, 25, 40, 70, 110, 130, 140, 120, 90, 60, 35, 25,
                 12, 18, 28, 45, 75, 95, 115, 105, 85, 55, 32, 22,
                 8, 15, 25, 42, 68, 88, 108, 98, 78, 48, 28, 18,
                 5, 12, 22, 38, 62, 82, 102, 92, 72, 42, 25, 15,
                 3, 10, 20, 35, 58, 78, 98, 88, 68, 38, 22, 12]
    ...
    def test_init_basic(self, simple_test_data):
        ...
        calculator = ExtremaCalculator("test_index", simple_test_data, threshold=50.0, window=90)
    ...
    def test_properties_access(self, simple_test_data):
        ...
        if hasattr(calculator, 'extrema_finders') and calculator.extrema_finders is not None:
    ...
    def test_comprehensive_workflow(self, synthetic_activity_index):
        ...
        assert not calculator.data.equals(synthetic_activity_index)  # Should be smoothed
...
class TestExtremaCalculatorEdgeCases:
    ...
    def test_nan_data_handling(self):
        ...
        try:
            calculator = ExtremaCalculator("nan_test", nan_data, threshold=50.0, window=None)
    ...
    def test_constant_data_handling(self):
        ...
        constant_data = pd.Series([50.0] * 100,
                                 index=pd.date_range('2010-01-01', periods=100, freq='D'),
                                 name='constant')
        
        # Test with slightly different threshold to avoid edge case
        try:
            calculator = ExtremaCalculator("constant", constant_data, threshold=49.0, window=None)
    ...
    def test_malformed_data_types(self):
        ...
        mixed_data = pd.Series([-10, -5, 0, 5, 10],
                              index=pd.date_range('2010-01-01', periods=5, freq='D'),
                              name='mixed_test')
        
        calculator = ExtremaCalculator("mixed_test", mixed_data, threshold=0.0, window=None)
