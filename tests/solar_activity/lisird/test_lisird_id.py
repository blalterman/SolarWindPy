...
class TestLISIRD_ID:
    ...
    def test_url_construction_valid_keys(self):
        ...
        test_cases = [
            ("Lalpha", "http://lasp.colorado.edu/lisird/latis/dap/composite_lyman_alpha.jsond"),
            ("CaK", "http://lasp.colorado.edu/lisird/latis/dap/cak.jsond"),
            ("f107-noaa", "http://lasp.colorado.edu/lisird/latis/dap/noaa_radio_flux.jsond"),
            ("f107-penticton", "http://lasp.colorado.edu/lisird/latis/dap/penticton_radio_flux.jsond"),
            ("MgII", "http://lasp.colorado.edu/lisird/latis/dap/composite_mg_index.jsond")
        ]
