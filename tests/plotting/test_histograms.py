...
class TestHist1DAggregation:
    ...
    def test_agg_sum_with_density_raises_value_error(self):
        ...
        with pytest.raises(ValueError, match="Unable to calculate a PDF with non-count aggregation"):
            hist.agg(fcn='sum')
...
class TestHist1DPlotting:
    ...
    def test_make_plot_invalid_fcn_raises_value_error(self):
        ...
        with pytest.raises(AttributeError, match="'SeriesGroupBy' object has no attribute"):
