...
This file provides shared test configuration for all tests in the consolidated
/tests/ directory structure. It enables external package imports for migrated
tests from solarwindpy/tests/.
"""
