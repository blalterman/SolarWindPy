...
class TestCircularImports:
    ...
    def test_cross_module_import_scenarios(self):
        ...
        for first_module, second_module in module_pairs:
            if first_module not in self.all_modules or second_module not in self.all_modules:
                continue
            ...
            try:
                ...
                if 'circular' in str(e).lower() or 'cannot import name' in str(e).lower():
                    circular_imports.append(f"{first_module} -> {second_module}: {str(e)}")
            ...
            try:
                ...
                if 'circular' in str(e).lower() or 'cannot import name' in str(e).lower():
                    circular_imports.append(f"{second_module} -> {first_module}: {str(e)}")
    ...
    def test_public_api_imports(self):
        ...
        assert len(circular_import_errors) == 0, (
    ...
    def test_import_time_performance(self):
        ...
        for module_name in self.key_modules:
            ...
            try:
                ...
                if 'circular' in str(e).lower():
                    pytest.fail(f"Circular import in performance test for {module_name}: {e}")
        ...
        if slow_imports:
            ...
            import warnings
            warnings.warn(f"Slow imports detected (possible circular import indicators): {slow_imports}")
...
class TestImportStructure:
    ...
    def test_relative_import_consistency(self):
        ...
        python_files = [
            f for f in self.package_root.rglob("*.py") 
        ...
        for py_file in python_files:
            ...
            has_absolute = 'from solarwindpy' in content or 'import solarwindpy' in content
