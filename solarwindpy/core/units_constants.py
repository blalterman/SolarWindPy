...
class Constants(object):
    ...
    def kb(self):
        ...
        return pd.Series({"J": constants.k,
                          "eV": physical_constants[ev][0]})
    @property
    def m_in_mp(self):
        mamp = physical_constants["alpha particle-proton mass ratio"][0]
        memp = physical_constants["electron-proton mass ratio"][0]
        return pd.Series({"p": 1.0,  "p1": 1.0,  "p2": 1.0,
                          "a": mamp, "a1": mamp, "a2": mamp,
                          "e": memp})
    @property
    def m(self):
        ma = physical_constants["alpha particle mass"][0]
        out = {"e": constants.m_e,
               "p": constants.m_p, "p1": constants.m_p, "p2": constants.m_p,
               "a": ma, "a1": ma, "a2": ma
              }
